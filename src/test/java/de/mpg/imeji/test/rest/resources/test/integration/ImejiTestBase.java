...
public class ImejiTestBase extends JerseyTest {
	...
	protected static HttpAuthenticationFeature authAsUser = HttpAuthenticationFeature.basic(JenaUtil.TEST_USER_EMAIL,
			JenaUtil.TEST_USER_PWD);
	protected static HttpAuthenticationFeature authAsUser2 = HttpAuthenticationFeature.basic(JenaUtil.TEST_USER_EMAIL_2,
			JenaUtil.TEST_USER_PWD);

	protected static HttpAuthenticationFeature authAsUserFalse = HttpAuthenticationFeature.basic("falseuser",
			"falsepassword");
	...
	public static String initCollection() {
		...
		try {
			collectionTO = (CollectionTO) RestProcessUtils
					.buildTOFromJSON(getStringFromPath(STATIC_CONTEXT_REST + "/collection.json"), CollectionTO.class);
