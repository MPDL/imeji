...
public class CollectionIntegration extends ImejiTestBase {
  ...
  public void test_1_CreateCollection_5_NoAuth() throws IOException {
    ...
    response = target(pathPrefix).register(authAsUserFalse).register(MultiPartFeature.class).request(MediaType.APPLICATION_JSON_TYPE)
        .post(Entity.entity(jsonString, MediaType.APPLICATION_JSON_TYPE));
    assertEquals(UNAUTHORIZED.getStatusCode(), response.getStatus());
  }
  ...
  public void test_2_ReadCollection_1() throws ImejiException {
    Response response = target(pathPrefix).path(collectionId).register(authAsUser).request(MediaType.APPLICATION_JSON).get();
  ...
  public void test_2_ReadCollection_4_Forbidden() throws ImejiException {
    Response response = target(pathPrefix).path(collectionId).register(authAsUser2).request(MediaType.APPLICATION_JSON).get();
    assertThat(response.getStatus(), equalTo(FORBIDDEN.getStatusCode()));
  }
  ...
  public void test_2_ReadCollection_4_DoesNotExist() throws IOException {
    Response response =
        target(pathPrefix).path(collectionId + "i_do_not_exist").register(authAsUser).request(MediaType.APPLICATION_JSON).get();
  ...
  public void test_2_ReadCollection_5_AllItems() throws Exception {
    initItem();
    Response response = target(pathPrefix).path(collectionId + "/items").register(authAsUser).request(MediaType.APPLICATION_JSON).get();
  ...
  public void test_3_ReleaseCollection_2_WithUnauth() throws ImejiException {
    ...
    initItem();
    assertEquals("PENDING", itemService.read(itemId, JenaUtil.testUser).getStatus());
    Response response = target(pathPrefix).path("/" + collectionId + "/release").register(authAsUser2)
        .request(MediaType.APPLICATION_JSON_TYPE).put(Entity.json("{}"));
  ...
  public void test_4_WithdrawCollection_1_WithAuth() throws ImejiException {
    ...
    Response response = target(pathPrefix).path("/" + collectionId + "/discard").register(authAsUser)
        .request((MediaType.APPLICATION_JSON_TYPE)).put(Entity.entity(form, MediaType.APPLICATION_FORM_URLENCODED_TYPE));
  ...
  public void test_4_WithdrawCollection_2_WithUnauth() throws ImejiException {
    ...
    Response response = target(pathPrefix).path("/" + collectionId + "/discard").register(authAsUser2)
        .request((MediaType.APPLICATION_JSON_TYPE)).put(Entity.entity(form, MediaType.APPLICATION_FORM_URLENCODED_TYPE));
  ...
  public void test_4_WithdrawCollection_3_WithNonAuth() throws ImejiException {
    ...
    Response response = target(pathPrefix).path("/" + collectionId + "/discard").request((MediaType.APPLICATION_JSON_TYPE))
        .put(Entity.entity(form, MediaType.APPLICATION_FORM_URLENCODED_TYPE));

    assertEquals(UNAUTHORIZED.getStatusCode(), response.getStatus());

    response = target(pathPrefix).path("/" + collectionId + "/discard").register(authAsUserFalse).request((MediaType.APPLICATION_JSON_TYPE))
        .put(Entity.entity(form, MediaType.APPLICATION_FORM_URLENCODED_TYPE));
  ...
  public void test_4_WithdrawCollection_6_NotExistingCollection() throws ImejiException {
    ...
    Response response = target(pathPrefix).path("/" + collectionId + "i_do_not_exist/discard").register(authAsUser)
        .request((MediaType.APPLICATION_JSON_TYPE)).put(Entity.entity(form, MediaType.APPLICATION_FORM_URLENCODED_TYPE));
  ...
  public void test_5_DeleteCollection_1_WithAuth() throws ImejiException {
    ...
    Response response = target(pathPrefix).path("/" + collectionId).register(authAsUser).request(MediaType.APPLICATION_JSON_TYPE).delete();

    assertEquals(Status.NO_CONTENT.getStatusCode(), response.getStatus());

    response = target(pathPrefix).path(collectionId).register(authAsUser).request(MediaType.APPLICATION_JSON).get();
  ...
  public void test_5_DeleteCollection_2_WithUnauth() throws ImejiException {
    initCollection();
    Response response = target(pathPrefix).path("/" + collectionId).register(authAsUser2).request(MediaType.APPLICATION_JSON_TYPE).delete();
  ...
  public void test_5_DeleteCollection_3_NotPendingCollection() {
    ...
    response = target(pathPrefix).path("/" + collectionId).register(authAsUser).request(MediaType.APPLICATION_JSON_TYPE).delete();
  ...
  public void test_5_DeleteCollection_1_nonExistingCollection() {
    Response response = target(pathPrefix).path("/" + collectionId + "i_do_not_exist").register(authAsUser)
  ...
  @Test
  public void test_6_UpdateCollection() throws IOException, BadRequestException, UnprocessableError {
    initCollection();
    ...
    Builder request = target(pathPrefix).path("/" + collectionId).register(authAsUser).register(JacksonFeature.class)
        .request(MediaType.APPLICATION_JSON_TYPE);

    Response response = request.put(Entity.entity(buildJSONFromObject(collectionTO), MediaType.APPLICATION_JSON));
    assertEquals(OK.getStatusCode(), response.getStatus());
