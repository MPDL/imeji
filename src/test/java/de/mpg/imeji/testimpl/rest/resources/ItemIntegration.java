...
public class ItemIntegration extends ItemTestBase {
  ...
  public void createItem_NotLoggedIn() throws IOException {
    ...
    Response response = target(PATH_PREFIX).register(MultiPartFeature.class)
    ...
    Response response2 =
        target(PATH_PREFIX).register(authAsUserFalse).register(MultiPartFeature.class)
            .register(JacksonFeature.class).request(MediaType.APPLICATION_JSON_TYPE)
            .post(Entity.entity(multiPart, multiPart.getMediaType()));
  ...
  public void test_1_UpdateItem_8_InvalidFetchURL() throws IOException {
    ...
    multiPart.field("json", getStringFromPath(updateJSON)
  ...
  public void test_1_deleteItem_WithNonAuth() throws Exception {
    ...
    Response response =
        target(PATH_PREFIX).path("/" + itemId).request(MediaType.APPLICATION_JSON_TYPE).delete();
    assertEquals(Status.UNAUTHORIZED.getStatusCode(), response.getStatus());
  ...
  public void test_3_deleteItem_NotExist() throws Exception {
    ...
    Response response = target(PATH_PREFIX).register(authAsUser)
