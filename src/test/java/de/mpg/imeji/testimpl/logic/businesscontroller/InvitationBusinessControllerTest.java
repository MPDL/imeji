...
public class InvitationBusinessControllerTest extends SuperServiceTest {
	...
	/**
	 * Invite an unknown user, create the user, check that the user got the roles
	 * from the invitation
	 * 
	...
	public void inviteAndConsume() throws ImejiException {
		...
		Invitation invitation = new Invitation(UNKNOWN_EMAIL, collectionBasic.getId().toString(),
