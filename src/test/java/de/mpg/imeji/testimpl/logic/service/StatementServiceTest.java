...
public class StatementServiceTest extends SuperServiceTest {
	...
	public static void specificSetup() {
		try {
			...
			defaultUser = ImejiFactory.newUser().setEmail("default3@test.org").setPerson("default3", "default3", "org")
					.setPassword("password").setQuota(Long.MAX_VALUE).build();
	...
	/**
	 * test if an unothorized user can't create statement, correct creation gets
	 * checked in Test if statement can be created twice retrieve
	 */
	@Test
	public void create() {
