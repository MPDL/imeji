...
public class UserServiceTest extends SuperServiceTest {
  ...
  public void create() {
    ...
    Assert.assertEquals("Default grants should be as expected",
        AuthorizationPredefinedRoles.defaultUser(defaultUser.getId().toString()),
  ...
  public void retrive() {
    ...
    try {
      ...
      User defaultByBatch = (User) service
          .retrieveBatch(Arrays.asList(defaultUser.getId().toString()), 10).toArray()[0];
      User defaultByBatchLazy = (User) service
          .retrieveBatchLazy(Arrays.asList(defaultUser.getId().toString()), 10).toArray()[0];
      Assert.assertEquals("ID should be as expected for email retrive",
          defaultUser.getId().toString(), defaultByEmail.getId().toString());
  ...
  public void retrivePersonById() {
    ...
    Assert.assertEquals("family name", defaultUser.getPerson().getFamilyName(),
        ret.getFamilyName());
  }
