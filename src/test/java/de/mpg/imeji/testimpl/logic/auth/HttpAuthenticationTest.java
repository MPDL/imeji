...
public class HttpAuthenticationTest {
	...
	public void loginWithEmailAndPassword() {
		try {
			User user = AuthenticationFactory
					.factory(generateBasicAuthenticationHeader(JenaUtil.TEST_USER_EMAIL, JenaUtil.TEST_USER_PWD))
					.doLogin();
	...
	public void loginWithWrongPassword() {
		try {
			AuthenticationFactory
					.factory(
							generateBasicAuthenticationHeader(JenaUtil.TEST_USER_EMAIL, JenaUtil.TEST_USER_PWD + "abc"))
					.doLogin();
			Assert.fail();
		} catch (AuthenticationError e) {
			// Correct
	...
	public void loginWithAPIKey() throws ImejiException, JoseException {
		...
		try {
			User user = AuthenticationFactory.factory(generateAPIKEYAuthenticationHeader(usertest.getApiKey()))
					.doLogin();
			Assert.assertNotNull(user);
		} catch (AuthenticationError e) {
			Assert.fail(e.getMessage());
	...
	/**
	 * Login a user which doesn't have an API Key (login is done with
	 * email/password)
	 * 
	 * @throws ImejiException
	 */
