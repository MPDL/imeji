...
function startLoader(){$(".loaderWrapper").show();$(".loader").show()}function stopLoader(){$(".loaderWrapper").hide();$(".loaderWrapper").removeClass("show");$(".loader").hide();$(".loader").removeClass("show")}jsf.ajax.addOnEvent(function(a){switch(a.status){case "complete":stopLoader()}});$(function(){$(".scrollbarTopWrapper").scroll(function(){$(".edit_selected_table_wrapper").scrollLeft($(".scrollbarTopWrapper").scrollLeft())});$(".edit_selected_table_wrapper").scroll(function(){$(".scrollbarTopWrapper").scrollLeft($(".edit_selected_table_wrapper").scrollLeft())})});
...
$(".showSection").click(function(){var a=$(this).data("section");console.log(a);$("."+a).slideToggle("fast");$("*[data-section\x3d'"+a+"']").toggle()});$(".hideSection").click(function(){var a=$(this).data("section");console.log(a);$("."+a).slideToggle("fast");$("*[data-section\x3d'"+a+"']").toggle()});
