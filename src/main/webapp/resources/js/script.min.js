var datasourceUrl,result,servlet,offset=2,id;function getDatasourceUrl(a,k){datasourceUrl=a;this.servlet=k;offset=2}function getDatasourceUrlWithFixedDelay(a,k,g){getDatasourceUrl(a,k);offset=g}function split(a){return a.split(/,\s*/)}function extractLast(a){return split(a).pop()}function setInputValue(a,k){null!=document.getElementById(a)&&(null!=k?document.getElementById(a).value=k:""==document.getElementById(a).value)}
$(function(){$(".autocomplete_js").bind("keydown",function(a){null!=datasourceUrl&&""!=datasourceUrl&&a.keyCode===$.ui.keyCode.TAB&&$(this).data("autocomplete").menu.active&&a.getPreventDefault()}).autocomplete({source:function(a,k){$.getJSON(servlet,{searchkeyword:a.term,datasource:datasourceUrl},function(a){result=a;k(result)})},minLength:0,messages:{noResults:"",results:function(){return""}},search:function(){if(null==datasourceUrl||""==datasourceUrl||extractLast(this.value).length<offset)return!1},
focus:function(){return!1},select:function(a,k){a=this.id.split(":");for(var g="",v=0;v<a.length-1;v++)g=g+a[v]+":";setInputValue(this.id,k.item.value);setInputValue(g+"identifier",k.item.id);setInputValue(g+"given",k.item.givenname);setInputValue(g+"family",k.item.family);setInputValue(g+"identifier",k.item.id);setInputValue(g+"organization:0:name",k.item.organization);setInputValue(g+"latitude",k.item.latitude);setInputValue(g+"longitude",k.item.longitude);return!1}}).focus(function(){0==offset&&
null!=datasourceUrl&&""!=datasourceUrl&&(this.value=" ",$(this).autocomplete("search"),this.value="",event.getPreventDefault())})});function endsWith(a,k){return-1!==a.indexOf(k,a.length-k.length)}function formatNumber(a){return a.replace(",",".").replace(" ","")}function isNumber(a){a=formatNumber(a);return!isNaN(parseFloat(a))&&isFinite(a)}
function sortOptionsByText(){var a,k;if(a=jQuery('select[data-sort\x3d"sort"]'))k=jQuery(a.find("option")),k=jQuery.makeArray(k).sort(function(a,k){return a.innerHTML>k.innerHTML?1:-1}),a.html(k)}function loadContent(a,k,g){$.ajax({type:"GET",url:a,cache:!1,success:function(a){k&&$(k).html(a);g&&setTimeout(g,15,k,a)}})}function validateInputNumber(a){a.value=formatNumber(a.value);isNumber(a.value)||(a.value="")}
...
function handleDisableButton(a){if("submit"===a.source.type)switch(a.status){case "begin":a.source.disabled=!0;break;case "complete":a.source.disabled=!1}}"undefined"!==typeof jsf&&jsf.ajax.addOnEvent(function(a){"success"===a.status&&fixViewState(a.responseXML);handleDisableButton(a)});function fixViewState(a){if(a=getViewState(a))for(var k=0;k<document.forms.length;k++){var g=document.forms[k];"post"===g.method.toLowerCase()?hasViewState(g)||createViewState(g,a):removeViewState(g)}}
function getViewState(a){a=a.getElementsByTagName("update");for(var k=0;k<a.length;k++){var g=a[k];if(g.getAttribute("id").match(/^([\w]+:)?javax\.faces\.ViewState(:[0-9]+)?$/))return g.firstChild.nodeValue}return null}function hasViewState(a){for(var k=0;k<a.elements.length;k++)if("javax.faces.ViewState"==a.elements[k].name)return!0;return!1}
function createViewState(a,k){var g;try{g=document.createElement("\x3cinput name\x3d'javax.faces.ViewState'\x3e")}catch(v){g=document.createElement("input"),g.setAttribute("name","javax.faces.ViewState")}g.setAttribute("type","hidden");g.setAttribute("value",k);g.setAttribute("autocomplete","off");a.appendChild(g)}function removeViewState(a){for(var k=0;k<a.elements.length;k++){var g=a.elements[k];"javax.faces.ViewState"==g.name&&g.parentNode.removeChild(g)}}var selectedSearch,numberOfContext=$(".imj_bodyContextSearch li").length;
function submitSimpleSearch(){""!=$("#simpleSearchInputText").val()&&goToSearch(selectedSearch);return!1}$(".imj_bodyContextSearch li").click(function(){goToSearch($(this).index()+1)});function goToSearch(a){var k="?";a=$(".imj_bodyContextSearch li:nth-child("+a+")").data("url");0<=a.indexOf("?")&&(k="\x26");window.open(a+k+"q\x3d"+encodeURIComponent($("#simpleSearchInputText").val()),"_self")}
$("#simpleSearchInput").focusin(function(){$(".imj_menuSimpleSearch").show()}).keyup(function(a){40==a.which?(incrementSelectedSearch(),highlightSearch()):38==a.which?(decrementSelectedSearch(),highlightSearch()):""!=$(this).val()&&$(".imj_menuSimpleSearch").show()});$(document).ready(function(){selectedSearch=1;var a=window.location.pathname;$("ul.imj_bodyContextSearch li").each(function(k){if(-1!==$(this).data("url").indexOf(a))return selectedSearch=k+1,!1});highlightSearch()});
...
setTimeout(function(){$(".imj_messageSuccess").slideUp(200)},4E3);function closeSuccessMessage(){setTimeout(function(){$(".imj_messageSuccess").slideUp(200)},4E3)}$(function(){$(".datepicker").datepicker({changeMonth:!0,changeYear:!0,dateFormat:"yy-mm-dd",firstDay:1})});$(".responsiveMenuBtn").click(function(){$("#"+$(this).data("menu")).slideToggle("slow",function(){$(this).toggleClass("show")})});
$(document).click(function(a){a.target.matches(".responsiveMenuBtn")||$(".show").slideToggle("slow",function(){$(this).toggleClass("show")})});$(".showSection").click(function(){var a=$(this).data("section");console.log(a);$("."+a).slideToggle("fast");$("*[data-section\x3d'"+a+"']").toggle()});$(".hideSection").click(function(){var a=$(this).data("section");console.log(a);$("."+a).slideToggle("fast");$("*[data-section\x3d'"+a+"']").toggle()});
...
var qrcode=function(){function a(t,k){if("undefined"==typeof t.length)throw Error(t.length+"/"+k);var n=function(){for(var c=0;c<t.length&&0==t[c];)c+=1;for(var b=Array(t.length-c+k),d=0;d<t.length-c;d+=1)b[d]=t[d+c];return b}(),b={getAt:function(c){return n[c]},getLength:function(){return n.length},multiply:function(c){for(var h=Array(b.getLength()+c.getLength()-1),d=0;d<b.getLength();d+=1)for(var f=0;f<c.getLength();f+=1)h[d+f]^=u.gexp(u.glog(b.getAt(d))+u.glog(c.getAt(f)));return a(h,0)},mod:function(c){if(0>
b.getLength()-c.getLength())return b;for(var h=u.glog(b.getAt(0))-u.glog(c.getAt(0)),d=Array(b.getLength()),f=0;f<b.getLength();f+=1)d[f]=b.getAt(f);for(f=0;f<c.getLength();f+=1)d[f]^=u.gexp(u.glog(c.getAt(f))+h);return a(d,0).mod(c)}};return b}var k=function(t,k){var n=g[k],b=null,c=0,h=null,d=[],f={},e=function(f,k){for(var l=c=4*t+17,m=Array(l),e=0;e<l;e+=1){m[e]=Array(l);for(var r=0;r<l;r+=1)m[e][r]=null}b=m;y(0,0);y(c-7,0);y(0,c-7);l=v.getPatternPosition(t);for(m=0;m<l.length;m+=1)for(e=0;e<
l.length;e+=1){var r=l[m],q=l[e];if(null==b[r][q])for(var g=-2;2>=g;g+=1)for(var p=-2;2>=p;p+=1)b[r+g][q+p]=-2==g||2==g||-2==p||2==p||0==g&&0==p?!0:!1}for(l=8;l<c-8;l+=1)null==b[l][6]&&(b[l][6]=0==l%2);for(l=8;l<c-8;l+=1)null==b[6][l]&&(b[6][l]=0==l%2);l=v.getBCHTypeInfo(n<<3|k);for(m=0;15>m;m+=1)e=!f&&1==(l>>m&1),6>m?b[m][8]=e:8>m?b[m+1][8]=e:b[c-15+m][8]=e;for(m=0;15>m;m+=1)e=!f&&1==(l>>m&1),8>m?b[8][c-m-1]=e:9>m?b[8][15-m-1+1]=e:b[8][15-m-1]=e;b[c-8][8]=!f;if(7<=t){l=v.getBCHTypeNumber(t);for(m=
0;18>m;m+=1)e=!f&&1==(l>>m&1),b[Math.floor(m/3)][m%3+c-8-3]=e;for(m=0;18>m;m+=1)e=!f&&1==(l>>m&1),b[m%3+c-8-3][Math.floor(m/3)]=e}if(null==h){f=A.getRSBlocks(t,n);l=B();for(m=0;m<d.length;m+=1)e=d[m],l.put(e.getMode(),4),l.put(e.getLength(),v.getLengthInBits(e.getMode(),t)),e.write(l);for(m=e=0;m<f.length;m+=1)e+=f[m].dataCount;if(l.getLengthInBits()>8*e)throw Error("code length overflow. ("+l.getLengthInBits()+"\x3e"+8*e+")");for(l.getLengthInBits()+4<=8*e&&l.put(0,4);0!=l.getLengthInBits()%8;)l.putBit(!1);
for(;!(l.getLengthInBits()>=8*e);){l.put(236,8);if(l.getLengthInBits()>=8*e)break;l.put(17,8)}for(var w=0,e=m=0,r=Array(f.length),q=Array(f.length),g=0;g<f.length;g+=1){var u=f[g].dataCount,x=f[g].totalCount-u,m=Math.max(m,u),e=Math.max(e,x);r[g]=Array(u);for(p=0;p<r[g].length;p+=1)r[g][p]=255&l.getBuffer()[p+w];w+=u;p=v.getErrorCorrectPolynomial(x);u=a(r[g],p.getLength()-1).mod(p);q[g]=Array(p.getLength()-1);for(p=0;p<q[g].length;p+=1)x=p+u.getLength()-q[g].length,q[g][p]=0<=x?u.getAt(x):0}for(p=
l=0;p<f.length;p+=1)l+=f[p].totalCount;l=Array(l);for(p=w=0;p<m;p+=1)for(g=0;g<f.length;g+=1)p<r[g].length&&(l[w]=r[g][p],w+=1);for(p=0;p<e;p+=1)for(g=0;g<f.length;g+=1)p<q[g].length&&(l[w]=q[g][p],w+=1);h=l}f=h;l=-1;m=c-1;e=7;r=0;k=v.getMaskFunction(k);for(q=c-1;0<q;q-=2)for(6==q&&--q;;){for(g=0;2>g;g+=1)null==b[m][q-g]&&(p=!1,r<f.length&&(p=1==(f[r]>>>e&1)),k(m,q-g)&&(p=!p),b[m][q-g]=p,--e,-1==e&&(r+=1,e=7));m+=l;if(0>m||c<=m){m-=l;l=-l;break}}},y=function(h,f){for(var d=-1;7>=d;d+=1)if(!(-1>=h+
d||c<=h+d))for(var a=-1;7>=a;a+=1)-1>=f+a||c<=f+a||(b[h+d][f+a]=0<=d&&6>=d&&(0==a||6==a)||0<=a&&6>=a&&(0==d||6==d)||2<=d&&4>=d&&2<=a&&4>=a?!0:!1)};f.addData=function(c){c=C(c);d.push(c);h=null};f.isDark=function(d,h){if(0>d||c<=d||0>h||c<=h)throw Error(d+","+h);return b[d][h]};f.getModuleCount=function(){return c};f.make=function(){for(var c=0,d=0,b=0;8>b;b+=1){e(!0,b);var h=v.getLostPoint(f);if(0==b||c>h)c=h,d=b}e(!1,d)};f.createTableTag=function(c,d){c=c||2;d='\x3ctable style\x3d" border-width: 0px; border-style: none; border-collapse: collapse;'+
(" padding: 0px; margin: "+("undefined"==typeof d?4*c:d)+"px;")+'"\x3e\x3ctbody\x3e';for(var b=0;b<f.getModuleCount();b+=1){d+="\x3ctr\x3e";for(var h=0;h<f.getModuleCount();h+=1)d+='\x3ctd style\x3d"',d+=" border-width: 0px; border-style: none;",d+=" border-collapse: collapse;",d+=" padding: 0px; margin: 0px;",d+=" width: "+c+"px;",d+=" height: "+c+"px;",d+=" background-color: ",d+=f.isDark(b,h)?"#000000":"#ffffff",d+=";",d+='"/\x3e';d+="\x3c/tr\x3e"}return d+"\x3c/tbody\x3e\x3c/table\x3e"};f.createImgTag=
function(c,d){c=c||2;d="undefined"==typeof d?4*c:d;var b=f.getModuleCount()*c+2*d,h=d,a=b-d;return D(b,b,function(d,b){return h<=d&&d<a&&h<=b&&b<a?f.isDark(Math.floor((b-h)/c),Math.floor((d-h)/c))?0:1:1})};return f};k.stringToBytes=function(a){for(var e=[],n=0;n<a.length;n+=1){var b=a.charCodeAt(n);e.push(b&255)}return e};k.createStringToBytes=function(a,e){var n=function(){for(var b=E(a),c=function(){var d=b.read();if(-1==d)throw Error();return d},h=0,d={};;){var f=b.read();if(-1==f)break;var n=
c(),g=c(),k=c(),f=String.fromCharCode(f<<8|n);d[f]=g<<8|k;h+=1}if(h!=e)throw Error(h+" !\x3d "+e);return d}();return function(b){for(var c=[],h=0;h<b.length;h+=1){var d=b.charCodeAt(h);128>d?c.push(d):(d=n[b.charAt(h)],"number"==typeof d?(d&255)==d?c.push(d):(c.push(d>>>8),c.push(d&255)):c.push(63))}return c}};var g={L:1,M:0,Q:3,H:2},v=function(){var g=[[],[6,18],[6,22],[6,26],[6,30],[6,34],[6,22,38],[6,24,42],[6,26,46],[6,28,50],[6,30,54],[6,32,58],[6,34,62],[6,26,46,66],[6,26,48,70],[6,26,50,74],
[6,30,54,78],[6,30,56,82],[6,30,58,86],[6,34,62,90],[6,28,50,72,94],[6,26,50,74,98],[6,30,54,78,102],[6,28,54,80,106],[6,32,58,84,110],[6,30,58,86,114],[6,34,62,90,118],[6,26,50,74,98,122],[6,30,54,78,102,126],[6,26,52,78,104,130],[6,30,56,82,108,134],[6,34,60,86,112,138],[6,30,58,86,114,142],[6,34,62,90,118,146],[6,30,54,78,102,126,150],[6,24,50,76,102,128,154],[6,28,54,80,106,132,158],[6,32,58,84,110,136,162],[6,26,54,82,110,138,166],[6,30,58,86,114,142,170]],e={},n=function(b){for(var c=0;0!=b;)c+=
1,b>>>=1;return c};e.getBCHTypeInfo=function(b){for(var c=b<<10;0<=n(c)-n(1335);)c^=1335<<n(c)-n(1335);return(b<<10|c)^21522};e.getBCHTypeNumber=function(b){for(var c=b<<12;0<=n(c)-n(7973);)c^=7973<<n(c)-n(7973);return b<<12|c};e.getPatternPosition=function(b){return g[b-1]};e.getMaskFunction=function(b){switch(b){case 0:return function(c,b){return 0==(c+b)%2};case 1:return function(c,b){return 0==c%2};case 2:return function(c,b){return 0==b%3};case 3:return function(c,b){return 0==(c+b)%3};case 4:return function(c,
b){return 0==(Math.floor(c/2)+Math.floor(b/3))%2};case 5:return function(c,b){return 0==c*b%2+c*b%3};case 6:return function(b,a){return 0==(b*a%2+b*a%3)%2};case 7:return function(b,a){return 0==(b*a%3+(b+a)%2)%2};default:throw Error("bad maskPattern:"+b);}};e.getErrorCorrectPolynomial=function(b){for(var c=a([1],0),h=0;h<b;h+=1)c=c.multiply(a([1,u.gexp(h)],0));return c};e.getLengthInBits=function(b,c){if(1<=c&&10>c)switch(b){case 1:return 10;case 2:return 9;case 4:return 8;case 8:return 8;default:throw Error("mode:"+
b);}else if(27>c)switch(b){case 1:return 12;case 2:return 11;case 4:return 16;case 8:return 10;default:throw Error("mode:"+b);}else if(41>c)switch(b){case 1:return 14;case 2:return 13;case 4:return 16;case 8:return 12;default:throw Error("mode:"+b);}else throw Error("type:"+c);};e.getLostPoint=function(b){for(var c=b.getModuleCount(),a=0,d=0;d<c;d+=1)for(var f=0;f<c;f+=1){for(var e=0,n=b.isDark(d,f),g=-1;1>=g;g+=1)if(!(0>d+g||c<=d+g))for(var k=-1;1>=k;k+=1)0>f+k||c<=f+k||0==g&&0==k||n!=b.isDark(d+
g,f+k)||(e+=1);5<e&&(a+=3+e-5)}for(d=0;d<c-1;d+=1)for(f=0;f<c-1;f+=1)if(e=0,b.isDark(d,f)&&(e+=1),b.isDark(d+1,f)&&(e+=1),b.isDark(d,f+1)&&(e+=1),b.isDark(d+1,f+1)&&(e+=1),0==e||4==e)a+=3;for(d=0;d<c;d+=1)for(f=0;f<c-6;f+=1)b.isDark(d,f)&&!b.isDark(d,f+1)&&b.isDark(d,f+2)&&b.isDark(d,f+3)&&b.isDark(d,f+4)&&!b.isDark(d,f+5)&&b.isDark(d,f+6)&&(a+=40);for(f=0;f<c;f+=1)for(d=0;d<c-6;d+=1)b.isDark(d,f)&&!b.isDark(d+1,f)&&b.isDark(d+2,f)&&b.isDark(d+3,f)&&b.isDark(d+4,f)&&!b.isDark(d+5,f)&&b.isDark(d+6,
f)&&(a+=40);for(f=e=0;f<c;f+=1)for(d=0;d<c;d+=1)b.isDark(d,f)&&(e+=1);return a+Math.abs(100*e/c/c-50)/5*10};return e}(),u=function(){for(var a=Array(256),e=Array(256),n=0;8>n;n+=1)a[n]=1<<n;for(n=8;256>n;n+=1)a[n]=a[n-4]^a[n-5]^a[n-6]^a[n-8];for(n=0;255>n;n+=1)e[a[n]]=n;return{glog:function(b){if(1>b)throw Error("glog("+b+")");return e[b]},gexp:function(b){for(;0>b;)b+=255;for(;256<=b;)b-=255;return a[b]}}}(),A=function(){var a=[[1,26,19],[1,26,16],[1,26,13],[1,26,9],[1,44,34],[1,44,28],[1,44,22],
...
10,55,25],[24,45,15,46,46,16],[4,152,122,18,153,123],[13,74,46,32,75,47],[48,54,24,14,55,25],[42,45,15,32,46,16],[20,147,117,4,148,118],[40,75,47,7,76,48],[43,54,24,22,55,25],[10,45,15,67,46,16],[19,148,118,6,149,119],[18,75,47,31,76,48],[34,54,24,34,55,25],[20,45,15,61,46,16]],e=function(b,a){var d={};d.totalCount=b;d.dataCount=a;return d},n={},b=function(b,h){switch(h){case g.L:return a[4*(b-1)+0];case g.M:return a[4*(b-1)+1];case g.Q:return a[4*(b-1)+2];case g.H:return a[4*(b-1)+3]}};n.getRSBlocks=
function(a,h){var d=b(a,h);if("undefined"==typeof d)throw Error("bad rs block @ typeNumber:"+a+"/errorCorrectLevel:"+h);a=d.length/3;h=[];for(var c=0;c<a;c+=1)for(var n=d[3*c+0],g=d[3*c+1],k=d[3*c+2],t=0;t<n;t+=1)h.push(e(g,k));return h};return n}(),B=function(){var a=[],e=0,n={getBuffer:function(){return a},getAt:function(b){return 1==(a[Math.floor(b/8)]>>>7-b%8&1)},put:function(b,a){for(var c=0;c<a;c+=1)n.putBit(1==(b>>>a-c-1&1))},getLengthInBits:function(){return e},putBit:function(b){var c=Math.floor(e/
8);a.length<=c&&a.push(0);b&&(a[c]|=128>>>e%8);e+=1}};return n},C=function(a){var e=k.stringToBytes(a);return{getMode:function(){return 4},getLength:function(a){return e.length},write:function(a){for(var b=0;b<e.length;b+=1)a.put(e[b],8)}}},z=function(){var a=[],e={writeByte:function(e){a.push(e&255)},writeShort:function(a){e.writeByte(a);e.writeByte(a>>>8)},writeBytes:function(a,b,c){b=b||0;c=c||a.length;for(var h=0;h<c;h+=1)e.writeByte(a[h+b])},writeString:function(a){for(var b=0;b<a.length;b+=
1)e.writeByte(a.charCodeAt(b))},toByteArray:function(){return a},toString:function(){var e;e="[";for(var b=0;b<a.length;b+=1)0<b&&(e+=","),e+=a[b];return e+"]"}};return e},F=function(){var a=0,e=0,g=0,b="",c={},h=function(a){if(!(0>a)){if(26>a)return 65+a;if(52>a)return 97+(a-26);if(62>a)return 48+(a-52);if(62==a)return 43;if(63==a)return 47}throw Error("n:"+a);};c.writeByte=function(d){a=a<<8|d&255;e+=8;for(g+=1;6<=e;)b+=String.fromCharCode(h(a>>>e-6&63)),e-=6};c.flush=function(){0<e&&(b+=String.fromCharCode(h(a<<
6-e&63)),e=a=0);if(0!=g%3)for(var d=3-g%3,c=0;c<d;c+=1)b+="\x3d"};c.toString=function(){return b};return c},E=function(a){var e=0,g=0,b=0,c=function(a){if(65<=a&&90>=a)return a-65;if(97<=a&&122>=a)return a-97+26;if(48<=a&&57>=a)return a-48+52;if(43==a)return 62;if(47==a)return 63;throw Error("c:"+a);};return{read:function(){for(;8>b;){if(e>=a.length){if(0==b)return-1;throw Error("unexpected end of file./"+b);}var h=a.charAt(e);e+=1;if("\x3d"==h)return b=0,-1;h.match(/^\s$/)||(g=g<<6|c(h.charCodeAt(0)),
b+=6)}h=g>>>b-8&255;b-=8;return h}}},G=function(a,e){var g=Array(a*e),b=function(a){var b=0,c=0;return{write:function(d,e){if(0!=d>>>e)throw Error("length over");for(;8<=b+e;)a.writeByte(255&(d<<b|c)),e-=8-b,d>>>=8-b,b=c=0;c|=d<<b;b+=e},flush:function(){0<b&&a.writeByte(c)}}},c=function(){var a={},b=0,c={add:function(d){if(c.contains(d))throw Error("dup key:"+d);a[d]=b;b+=1},size:function(){return b},indexOf:function(b){return a[b]},contains:function(b){return"undefined"!=typeof a[b]}};return c};
return{setPixel:function(b,c,e){g[c*a+b]=e},write:function(h){h.writeString("GIF87a");h.writeShort(a);h.writeShort(e);h.writeByte(128);h.writeByte(0);h.writeByte(0);h.writeByte(0);h.writeByte(0);h.writeByte(0);h.writeByte(255);h.writeByte(255);h.writeByte(255);h.writeString(",");h.writeShort(0);h.writeShort(0);h.writeShort(a);h.writeShort(e);h.writeByte(0);var d;d=3;for(var f=c(),k=0;4>k;k+=1)f.add(String.fromCharCode(k));f.add(String.fromCharCode(4));f.add(String.fromCharCode(5));var k=z(),n=b(k);
n.write(4,d);for(var q=0,r=String.fromCharCode(g[q]),q=q+1;q<g.length;){var l=String.fromCharCode(g[q]),q=q+1;f.contains(r+l)?r+=l:(n.write(f.indexOf(r),d),4095>f.size()&&(f.size()==1<<d&&(d+=1),f.add(r+l)),r=l)}n.write(f.indexOf(r),d);n.write(5,d);n.flush();d=k.toByteArray();h.writeByte(2);for(f=0;255<d.length-f;)h.writeByte(255),h.writeBytes(d,f,255),f+=255;h.writeByte(d.length-f);h.writeBytes(d,f,d.length-f);h.writeByte(0);h.writeString(";")}}},D=function(a,e,g,b){for(var c=G(a,e),h=0;h<e;h+=1)for(var d=
0;d<a;d+=1)c.setPixel(d,h,g(d,h));g=z();c.write(g);c=F();g=g.toByteArray();for(h=0;h<g.length;h+=1)c.writeByte(g[h]);c.flush();c='\x3cimg src\x3d"data:image/gif;base64,'+c+'" width\x3d"';c+=a;c+='"';c+=' height\x3d"';c+=e;c+='"';b&&(c+=' alt\x3d"',c+=b,c+='"');return c+="/\x3e"};return k}();(function(a){"function"===typeof define&&define.amd?define([],a):"object"===typeof exports&&(module.exports=a())})(function(){return qrcode});