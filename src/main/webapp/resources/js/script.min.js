...
focus:function(){return!1},select:function(a,b){a=this.id.split(":");for(var c="",u=0;u<a.length-1;u++)c=c+a[u]+":";console.log(c);setInputValue(this.id,b.item.value);setInputValue(c+"identifier",b.item.id);setInputValue(c+"given",b.item.givenname);setInputValue(c+"family",b.item.family);setInputValue(c+"identifier",b.item.id);setInputValue(c+"organization:0:name",b.item.organization);setInputValue(c+"latitude",b.item.latitude);setInputValue(c+"longitude",b.item.longitude);return!1}}).focus(function(){0==
offset&&null!=datasourceUrl&&""!=datasourceUrl&&(this.value=" ",$(this).autocomplete("search"),this.value="",event.getPreventDefault())})});$(function(){$(".datepicker").datepicker({changeMonth:!0,changeYear:!0,dateFormat:"yy-mm-dd",firstDay:1})});function endsWith(a,b){return-1!==a.indexOf(b,a.length-b.length)}function formatNumber(a){return a.replace(",",".").replace(" ","")}function isNumber(a){a=formatNumber(a);return!isNaN(parseFloat(a))&&isFinite(a)}
...
function highlightSearch(){$("ul.imj_bodyContextSearch li").removeClass("hovered");$("ul.imj_bodyContextSearch li:nth-child("+selectedSearch+")").addClass("hovered");changePlaceholder()}function incrementSelectedSearch(){selectedSearch<numberOfContext&&(selectedSearch+=1)}function decrementSelectedSearch(){1<selectedSearch&&--selectedSearch}$(document).ready(function(){resizeMenu()});function resizeMenu(){var a=$(".imj_menuHeader").outerWidth(!0);$(".imj_menuSimpleSearch").css({width:a})}
function lockPage(){$(".loaderWrapper").show()}function unlockPage(){$(".loaderWrapper").hide()}function startLoader(){$(".loaderWrapper").show();$(".loader").show()}function stopLoader(){$(".loaderWrapper").hide();$(".loader").hide()}jsf.ajax.addOnEvent(function(a){switch(a.status){case "complete":stopLoader()}});$(function(){$(".scrollbarTopWrapper").scroll(function(){$(".edit_selected_table_wrapper").scrollLeft($(".scrollbarTopWrapper").scrollLeft())});$(".edit_selected_table_wrapper").scroll(function(){$(".scrollbarTopWrapper").scrollLeft($(".edit_selected_table_wrapper").scrollLeft())})});
setTimeout(function(){$(".imj_messageSuccess").fadeOut(1E3)},2E3);
