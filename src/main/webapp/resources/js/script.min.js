...
setTimeout(function(){$(".imj_messageSuccess").slideUp(200)},2E3);function closeSuccessMessage(){setTimeout(function(){$(".imj_messageSuccess").slideUp(200)},2E3)}$(document).ready(function(){var a=0,g=0;$(".imj_tileItem").each(function(){var c=$(this).position().top;if(0<g&&c>g)return a=$(".imj_tileItem").index(this),!1;g=c});var c=new Date;c.setTime(+c+31536E6);0<a&&(document.cookie="ELEMENTS_PER_LINE_COOKIE\x3d"+a+"; expires\x3d"+c.toGMTString()+"; path\x3d/")});
