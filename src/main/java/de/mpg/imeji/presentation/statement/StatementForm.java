...
public class StatementForm implements Serializable {
	...
	public Statement asStatement() {
		return new StatementFactory().setIndex(name).setType(StatementType.valueOf(type)).setNamespace(namespace)
				.setVocabulary(getVocabulary()).setLiteralsConstraints(predefinedValues).build();
	}
	...
	/**
	 * @param useGoogleMapsAPI
	 *            the useGoogleMapsAPI to set
	 */
	...
	/**
	 * @param useMaxPlanckAuthors
	 *            the useMaxPlanckAuthors to set
	 */
