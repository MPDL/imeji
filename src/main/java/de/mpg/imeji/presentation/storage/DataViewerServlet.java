...
public class DataViewerServlet extends HttpServlet {
  ...
  protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
    try {
      ...
      final Item item = new ItemService().retrieveLazy(ObjectHelper.getURI(Item.class, req.getParameter("id")), sb.getUser());
  ...
  private String viewGenericFile(Item item, String fileType, String dataViewerServiceTargetURL)
    ...
    final Response response = target.register(MultiPartFeature.class).request(MediaType.MULTIPART_FORM_DATA_TYPE, MediaType.TEXT_HTML_TYPE)
