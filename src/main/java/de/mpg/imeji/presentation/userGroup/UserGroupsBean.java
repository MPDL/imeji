...
public class UserGroupsBean extends SuperBean {
  ...
  public void search() {
    try {
      ...
      String redirectTo =
          getNavigation().getApplicationUrl() + "usergroups?q=" + query + (backContainerUrl != null ? "&back=" + backContainerUrl : "");
  ...
  public String remove() {
    final String id = FacesContext.getCurrentInstance().getExternalContext().getRequestParameterMap().get("group");
