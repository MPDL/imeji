...
public class FacetsBean extends SuperBean {
	...
	public void delete() {
		final String index = FacesContext.getCurrentInstance().getExternalContext().getRequestParameterMap()
				.get("index");
		try {
	...
	/**
	 * Move the facet in the position to the top. i.e., get a lower position to
	 * appear one position higher in the list
	 * 
	 * @param facet
	...
	/**
	 * Move the facet to the bottom of the list, i.e. get a higher position to
	 * appear one position lower in the list
	 * 
	 * @param facet
	 * @throws ImejiException
	 */
