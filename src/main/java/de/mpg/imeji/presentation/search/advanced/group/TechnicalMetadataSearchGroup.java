 ...
 *
 */
public class TechnicalMetadataSearchGroup extends AbstractAdvancedSearchFormGroup implements Serializable {
	...
	public class TechnicalMetadataElement implements Serializable {
		...
		/**
		 * Return the {@link TechnicalMetadataElement} as
		 * {@link SearchTechnicalMetadata}
		 * 
		 * @return
		 */
