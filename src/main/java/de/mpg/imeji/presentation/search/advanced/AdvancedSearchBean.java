...
public class AdvancedSearchBean extends SuperBean {
  ...
  private void initMenus() {
    ...
    operatorsMenu.add(new SelectItem(LOGICAL_RELATIONS.AND, Imeji.RESOURCE_BUNDLE.getLabel("and_small", getLocale())));
    operatorsMenu.add(new SelectItem(LOGICAL_RELATIONS.OR, Imeji.RESOURCE_BUNDLE.getLabel("or_small", getLocale())));
  }
