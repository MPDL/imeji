...
public class AdvancedSearchBean extends SuperBean {
	...
	/**
	 * Called when the page is called per get request. Read the query in the url and
	 * initialize the form with it
	 *
	 * @return
	...
	private void initMenus() {
		...
		operatorsMenu
				.add(new SelectItem(LOGICAL_RELATIONS.AND, Imeji.RESOURCE_BUNDLE.getLabel("and_small", getLocale())));
		operatorsMenu
				.add(new SelectItem(LOGICAL_RELATIONS.OR, Imeji.RESOURCE_BUNDLE.getLabel("or_small", getLocale())));
	}
