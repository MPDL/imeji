...
public class CookieUtils {
	...
	/**
	 * Read a cookie. If not found, the default value is returned. After the cookie
	 * has been read, the cookie is updated (new max age, default value set if
	 * needed)
	 *
	 * @param name
	 * @param defaultValue
	...
	/**
	 * Read a cookie from the current http request. If the cookie doesn't exist,
	 * return null
	 *
	 * @param name
