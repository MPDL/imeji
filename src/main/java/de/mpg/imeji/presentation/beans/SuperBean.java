...
/**
 * This bean is a utility Bean. It can be extended to get some basic session
 * information
 *
 * @author bastiens
 *
...
public class SuperBean implements Serializable {
	...
	protected void goBack() throws IOException {
		redirect(!StringHelper.isNullOrEmptyTrim(backUrl)
				? URLDecoder.decode(backUrl, "UTF-8")
