...
public class ItemBean extends SuperBean {
	...
	public void save() throws IOException {
		try {
			...
			BeanHelper.error(
					Imeji.RESOURCE_BUNDLE.getMessage("error_metadata_edit", getLocale()) + ": " + e.getMessage());
			LOGGER.error("Error saving item metadata", e);
		}
	}
	...
	/**
	 * True if the File is a RAW file (a file which can not be viewed in any online
	 * tool)
	 *
	 * @return
	 */
	...
	/**
	 * Called when a picture is rotated by Openseadragon. If the user is authorized
	 * to rotate the image, webresolution and thumbnail get rotated
	 *
	 * @throws Exception
	 * @throws IOException
	 */
