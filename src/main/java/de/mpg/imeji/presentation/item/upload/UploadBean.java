...
public class UploadBean extends SuperBean {
  ...
  public void init() {
    try {
      if (getSessionUser() != null) {
        ...
        } else if (collections.isEmpty() && !SecurityUtil.authorization().hasCreateCollectionGrant(getSessionUser())) {
  ...
  public void filterCollections() throws ImejiException {
    ...
    collections = new CollectionService().searchAndRetrieve(factory.build(), new SortCriterion(SearchFields.modified, SortOrder.DESCENDING),
