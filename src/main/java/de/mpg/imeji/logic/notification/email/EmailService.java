...
public class EmailService {
  ...
  private void sendMail(String to, String from, String[] replyTo, String subject, String message)
    ...
    sendMail(server, port, auth, emailUser, password, sender, recipientsAdress, null, null, replyTo, subject, message);
  }
  ...
  public String sendMail(String smtpHost, String port, String withAuth, String usr, String pwd, String senderAddress,
      ...
      String subject, String text) throws ImejiException {
