...
public class EmailService {
	 ...
	 */
	public void sendMail(String to, String from, Email email) throws IOException, URISyntaxException, ImejiException {
	 ...
	 * @throws ImejiException
	 */
	public void sendMail(String to, String from, String subject, String message) throws ImejiException {
		try {
	...
	private void sendMail(String to, String from, String[] replyTo, String subject, String message)
		...
		sendMail(server, port, auth, emailUser, password, sender, recipientsAdress, null, null, replyTo, subject,
				message);
	}
	...
	public String sendMail(String smtpHost, String port, String withAuth, String usr, String pwd, String senderAddress,
			...
			String[] replytoAddresses, String subject, String text) throws ImejiException {
