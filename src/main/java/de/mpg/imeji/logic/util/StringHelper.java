...
public class StringHelper {
	...
	/**
	 * Tha maximum size of a file: Theorically, the max length could be 255. For
	 * security, imeji uses a lower count.
	 */
	...
	/**
	 * Transform a filename to a correct filename, which can be used by the internal
	 * storage to store a file
	 *
	 * @param filename
	 * @return
	 * @throws UnsupportedEncodingException
