...
public class UrlHelper {
  ...
  public static boolean getParameterBoolean(String parameterName) {
    final String str = FacesContext.getCurrentInstance().getExternalContext().getRequestParameterMap().get(parameterName);
    if ("1".equals(str)) {
      return true;
    }
    return false;
  ...
  public static Boolean hasParameter(String parameterName) {
    return FacesContext.getCurrentInstance().getExternalContext().getRequestParameterMap().containsKey(parameterName);
  }
