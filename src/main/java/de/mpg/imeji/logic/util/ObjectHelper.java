...
public class ObjectHelper {
	...
	/**
	 * Get the {@link URI} of {@link Object} according to its {@link Class} and the
	 * id (not uri)
	 *
	 * @param o
	 * @return
	...
	/**
	 * Copy {@link Field} from obj1 to obj2. Only Fields with same name and same
	 * type are copied. Fields from superclass are not copied.
	 *
	 * @param obj1
	 * @param obj2
	 */
	...
	/**
	 * Copy {@link Field} from obj1 to obj2. Only Fields with same name and same
	 * type are copied. Fields from superclass are copied.
	 *
	 * @param obj1
	 * @param obj2
	 */
