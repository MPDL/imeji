...
/**
 * {@link ImageGenerator} that returns a stored jpg icon file
 * Different icons files exist for different extensions (i.e. txt, ppt, etc)
 * 
 * @author jandura
 *
 */
...
public class TextFileIconGenerator extends ImageGenerator {
  ...
  public File generatePreview(File file, String fileExtension) throws ImejiException {
	  ...
	  try {
	      URL textIconResource = RawFileImageGenerator.class.getClassLoader()
	          .getResource(textFileIcon.getIconPath());
