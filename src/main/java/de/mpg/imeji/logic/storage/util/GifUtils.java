...
public class GifUtils {
	...
	/**
	 * Convert a gif to a jpeg and st the transparency of the jpeg to the passed
	 * color
	 *
	 * @param bytes
	...
	private static byte[] convert(byte[] bytes, Color backgroundColor) throws Exception {
		...
		final BufferedImage newBi = new BufferedImage(bufferedImage.getWidth(), bufferedImage.getHeight(),
