...
public final class ImageGeneratorManager {
  ...
  /**
   * List of classes that are able to create a preview image of a given file. Order of the list
   * matters: For creating a preview image the list is processed top-down and the first class that
   * "fits" the file type creates the image file.
   */
  ...
  /**
   * Uses a list of {@link ImageGenerator}s to create a preview (in jpg format) for a given file
   *
