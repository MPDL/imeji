...
/**
 * Interface for classes that create icons and image previews for files - for
 * general files: create icons (thumbnail size, tile size) - for image files:
 * create image previews (a thumbnail image and a web resolution images)
 *
...
public abstract class ImageGenerator {
	...
	/**
	 * Generate a jpg image (icon/preview) for a given file If the
	 * {@link ImageGenerator} can not generate the file, return null
	 *
	 * @param file
	 *            the file for which an icon or a preview shall be created
	 * @param fileExtension
	...
	/**
	 * return true if your {@link ImageGenerator} creates an icon or image for the
	 ...
	 * 
	 * @param file
	 *            the file for which a preview shall be created
	 * @return the generated preview (icon or image), null if there was a problem
