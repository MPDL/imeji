...
/**
 * Interface for classes that create icons and image previews for files
 *  - for general files: create icons (thumbnail size, tile size)
 *  - for image files: create image previews (a thumbnail image and a web resolution images)
 *
...
public abstract class ImageGenerator {
   ...
   /**
   * Generate a jpg image (icon/preview) for a given file
   ...
   *         null if a preview could not be generated
   */
   ...
   /**
    * return true if your {@link ImageGenerator} creates an icon or image for the given file extension
    * @param fileExtension
    * @return
    */
