...
/**
 * Represents an icon that can be loaded and written on.
 * User can write customized text on an icon and
 * set font size, color, position etc. of the written content.
 * @author breddin
 *
 */
