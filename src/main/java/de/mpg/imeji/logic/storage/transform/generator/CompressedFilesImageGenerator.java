 ...
 * Icon consists of
 *   - a background image
 *   - on top of the background image we write the file extension (zip, tar, etc)  
 * 
 * @author breddin
 *
 */
public class CompressedFilesImageGenerator extends AbstractWritableImageGenerator{
	...
	private static final String[] archivedCompressedMimeTypes = {"application/zip", "application/x-gtar", 
								...
								"application/x-rar-compressed" , "application/vnd.android.package-archive", "application/x-zoo",
								"application/x-ace-compressed", "application/x-cfs-compressed", "application/x-gca-compressed",
