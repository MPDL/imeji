...
/**
 * Generates an icon/preview image for compressed/archive files types i.e. zip,
 * tar, gz, 7z, .. Icon consists of - a background image - on top of the
 * background image we write the file extension (zip, tar, etc)
 * 
 * @author breddin
 *
 */
public class CompressedFilesImageGenerator extends AbstractWritableImageGenerator {
	...
	/**
	 * Collection of mime types of archives and compressed files/archives that are
	 * supported by this {@link ImageGenerator}
	 */
	private static final String[] archivedMimeTypes = {"application/x-tar", "application/x-shar"};
	private static final String[] compressedMimeTypes = {"application/x-compress", "application/gzip",
			"application/x-lzip", "application/x-xz", "application/x-lzma", "application/x-snappy-framed",
			"application/x-lzop", "application/x-bzip2"};

	private static final String[] archivedCompressedMimeTypes = {"application/zip", "application/x-gtar",
			"application/x-ustar", "application/x-7z-compressed", "application/x-rar-compressed",
			"application/vnd.android.package-archive", "application/x-zoo", "application/x-ace-compressed",
			"application/x-cfs-compressed", "application/x-gca-compressed", "application/x-stuffit",
	...
	/**
	 * Function creates a preview image for compressed/archive files (i.e. zip, tar,
	 * 7z, z, rar)
	 */
	@Override
