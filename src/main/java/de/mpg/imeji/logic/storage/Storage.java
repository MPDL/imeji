...
public interface Storage extends Serializable {
	...
	/**
	 * The name (as {@link String}) of the {@link Storage} as defined in the
	 * imeji.properties
	 *
	 * @return
	 */
	...
	/**
	 * Update the file stored in the passed url with a new original resolution
	 * (original resolution is not updated)
	 *
	 * @param url
	 * @param bytes
	 */
	 ...
	 * 
	 * @param urlOfBaseFile
	 *            url of the file for which full, web and thumbnail images are
	 *            created
	 */
