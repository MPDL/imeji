...
public class JpegUtils {
	...
	/**
	 * Read a {@link Byte} array and transform it to a {@link BufferedImage}. The
	 * input must by an image file
	 *
	 * @param bytes
	 * @return
	 * @throws IOException
	...
	/**
	 * Read a {@link File} and transform it to a {@link BufferedImage}. The input
	 * must by an image file
	 *
	 * @param file
	 * @return
	 * @throws IOException
