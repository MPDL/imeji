...
public abstract class SearchServiceAbstract<T> extends ImejiServiceAbstract {
   ...
   * @return
   */
  public abstract SearchResult search(SearchQuery searchQuery, SortCriterion sortCri, User user, int size, int offset);
   ...
   * @throws ImejiException
   */
  public List<T> searchAndRetrieve(SearchQuery searchQuery, SortCriterion sortCri, User user, int size, int offset) throws ImejiException {
