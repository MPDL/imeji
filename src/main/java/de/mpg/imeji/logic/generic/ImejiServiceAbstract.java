...
public abstract class ImejiServiceAbstract {
   ...
   */
  protected CollectionImeji setLogo(CollectionImeji col, File f) throws ImejiException, IOException, URISyntaxException {
    ...
    if (f != null) {
      ...
      File jpeg = new ImageGeneratorManager().generateWebResolution(f, StorageUtils.guessExtension(f));
      if (jpeg == null) {
