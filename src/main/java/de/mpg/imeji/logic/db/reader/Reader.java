...
/**
 * Object reader interface for imeji. Important: {@link Reader} doens't check
 * Authorization. Please use {@link ReaderFacade} instead.
 *
...
public interface Reader {
	...
	/**
	 * Read a single Object by its uri (Lazy means don't load Lazy list within the
	 * object)
	 *
	 * @param uri
	 * @param user
	...
	/**
	 * Read a List of objects. All objects must have an uri. (Lazy means don't load
	 * Lazy list within the object)
	 *
	 * @param objects
	 * @param user
	 * @return
