...
public interface Search {
	...
	/**
	 * Use this constant to state that you want to retrieve all existing search
	 * results of a query without any size limits
	 */
	public static final int GET_ALL_RESULTS = -1000; //

	/**
	 * Use this constant to state that you want to retrieve data starting at result
	 * index 0
	 */
	 ...
	 * same category with a second sort criterion)
	 * 
	 * @param query
	 * @param sortCriteria
	 * @param user
