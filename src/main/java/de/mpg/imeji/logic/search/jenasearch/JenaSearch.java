...
public class JenaSearch implements Search {
	...
	/**
	 * Search for {@link SearchQuery} according to {@link User} permissions, within
	 ...
	 */
	@Override
	public SearchResult searchString(String sparqlQuery, SortCriterion sort, User user, int from, int size) {
	...
	/**
	 * Search for complex queries over a set of data (defined by the previousResults
	 * parameter as a {@link List} of {@link Object} uris):<br/>
	...
	/**
	 * REturn a sparql query {@link String} to be added to search query in some
	 * specific cases
	 *
	 * @return
	 */
	...
	/**
	 * Return the name of the {@link Model} as a {@link String} according to the
	 * current {@link SearchObjectTypes}
	 *
	 * @param type
	 * @return
	 */
	...
	/**
	 * Return the {@link RDF}.type of object searched according to the
