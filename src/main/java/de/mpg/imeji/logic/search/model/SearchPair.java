...
/**
 * Define a pair of a {@link SearchIndex} with a {@link String} value, related
 * by a {@link SearchOperators}<br/>
...
public class SearchPair extends SearchElement {
	...
	/**
	 * If the element can be reduced to one Pair, return a pair. Otherwise return
	 * null
	 *
	 * @param element
	 * @return
