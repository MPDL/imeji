...
public class SearchFactory {
	...
	public SearchFactory initQuery(String query) throws UnprocessableError {
		this.query = new SearchQuery(
				query != null ? SearchQueryParser.parseStringQuery(query).getElements() : new ArrayList<>());
		return this;
	}
	 ...
	 * <li>Note: only the first level elements can be removed. (for example, a pair
	 * of a group can't be removed)
	 * 
	 * @param element
	 */
	 ...
	 * <li>Note: only the first level can be found. (for example, a pair of a group
	 * won't be found)
	 * 
	 * @param element
	 * @return
	...
	public static void main(String[] args) throws UnprocessableError {
		String q1 = "(creator%3Dadmin%40imeji.org+OR+collaborator%3Dadmin%40imeji.org AND (md.album.text%3D1+Album+au+hasard) AND () OR (creator%3Dadmin%40imeji.org+OR+collaborator%3Dadmin%40imeji.org AND (md.album.text%3D1+Album+au+hasard AND ())))";
	 ...
	 * @throws UnprocessableError
	 */
	public SearchFactory addOrGroup(List<SearchElement> elements, LOGICAL_RELATIONS rel) throws UnprocessableError {
	 ...
	 * @throws UnprocessableError
	 */
	public SearchFactory addAndGroup(List<SearchElement> elements, LOGICAL_RELATIONS rel) throws UnprocessableError {
		query.addLogicalRelation(rel);
	...
	/**
	 * Add a SearchElement to the query. Valid elements: {@link SearchPair},
	 * {@link SearchGroup}, {@link SearchMetadata}, {@link SearchTechnicalMetadata}
	 * 
	 * @param element
	 * @param rel
	 * @return
	 * @throws UnprocessableError
	 */
	public SearchFactory addElement(SearchElement element, LOGICAL_RELATIONS rel) throws UnprocessableError {
