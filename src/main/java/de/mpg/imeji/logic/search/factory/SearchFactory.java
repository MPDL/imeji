...
public class SearchFactory {
  ...
  public SearchFactory initQuery(String query) throws UnprocessableError {
    this.query = new SearchQuery(query != null ? SearchQueryParser.parseStringQuery(query).getElements() : new ArrayList<>());
    return this;
  }
  ...
  public List<SearchMetadata> getElementsWithIndex(String index) {
    ...
    return query.getElements().stream().filter(e -> e instanceof SearchMetadata && ((SearchMetadata) e).getIndex().equals(mdIndex))
