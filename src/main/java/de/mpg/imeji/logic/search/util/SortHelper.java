...
public class SortHelper {
	...
	/**
	 * If a list has a sortValue parameter, sort it, otherwise remove the sortValue
	 * pattern
	 *
	 * @param l
	 * @return
	...
	/**
	 * Extract the value used by the sortering for this {@link String}. If no Sort
	 * value, return an emtpy {@link String}
	 *
	 * @param s
	 * @return
	 */
	...
	/**
	 * True if the {@link List} of String is sortable (i.e. that the String are
	 * defined with a sort value)
	 *
	 * @param l
	 * @return
	 */
	...
	/**
	 * Transform a {@link List} of {@link ComparableSearchResult} into a
