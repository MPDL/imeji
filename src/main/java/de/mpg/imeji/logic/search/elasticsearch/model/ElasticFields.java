...
public enum ElasticFields {
  ALL, ID, NAME, DESCRIPTION, SPACE, READ, COLLECTIONSINSPACE, STATUS, LASTEDITOR, CREATOR, CREATED, MODIFIED, MEMBER, PID, FILETYPE, SIZE, FOLDER, PROFILE, ALBUM, CHECKSUM, FILENAME, METADATA, METADATA_TEXT(
