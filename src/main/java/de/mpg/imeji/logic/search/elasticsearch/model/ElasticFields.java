...
public enum ElasticFields {
	ALL, ID, IDSTRING, NAME, DESCRIPTION, FULLTEXT, LICENSE, READ, UPLOAD, USERS, STATUS, LASTEDITOR, CREATOR, CREATORS, CREATED, MODIFIED, FAMILYNAME, GIVENNAME, ORGANIZATION, MEMBER, PID, FILETYPE, FILEEXTENSION, SIZE, FOLDER, PROFILE, ALBUM, CHECKSUM, METADATA, METADATA_EXACT(
	...
	/**
	 * If this field has the subfield "exact": important for fields which should be
