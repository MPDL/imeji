...
/**
 * Utility Class for ElasticSearch Contains common search options for
 * ElasticSearch
 *
 * @author bastiens
 *
...
public class ElasticSearchFactoryUtil {
	...
	/**
	 * Function searches ElasticSearch database Retrieves all documents (of a given
	 * type) that have no or an empty field
	 * 
	 * @param dataType
	 *            type of documents that will be searched
	 * @param nameOfMissingField
	 *            name of the field
	 ...
	 * {@link SearchRequestBuilder}
	 * 
	 * Add a list of Imeji {@link SortCriterion}. These are used to sort results as
	 * follows:
	 * 
	 * Results are first sorted by the first sort criterion in the list Elements
	 * that fall into the same category are then sorted by the second criterion of
	 * the list and so on
	 * 
	 ...
	 */
	public static SearchRequestBuilder addSorting(SearchRequestBuilder searchRequestBuilder,
	...
	/**
	 * Escape input to avoid error in Elasticsearch. * and ? are unescaped, to allow
	 * wildcard search
	 *
	 * @param s
	 * @return
