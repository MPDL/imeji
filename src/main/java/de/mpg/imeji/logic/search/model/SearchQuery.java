...
public class SearchQuery extends SearchElement {
	 ...
	 * <li>Note: Only first level elements are found, i.e. a searchPair will not be
	 * found if included into a searchgroup
	 * 
	 * @param query
	 * @param element
	 * @return
	...
	/**
	 * Transform a SearchElent to a SearchQuery when possible (i.e for SearchPair
	 * and SearchGroup)
	 *
	 * @param element
	 * @return
