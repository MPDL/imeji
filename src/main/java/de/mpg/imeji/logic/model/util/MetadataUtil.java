...
public class MetadataUtil {
	...
	/**
	 * Return true if the {@link Metadata} has an empty value (which shouldn't be
	...
	public static boolean isEmpty(Metadata md) {
		return StringHelper.isNullOrEmptyTrim(md.getText()) && StringHelper.isNullOrEmptyTrim(md.getDate())
				&& StringHelper.isNullOrEmptyTrim(md.getTitle()) && StringHelper.isNullOrEmptyTrim(md.getName())
				&& Double.isNaN(md.getNumber())
