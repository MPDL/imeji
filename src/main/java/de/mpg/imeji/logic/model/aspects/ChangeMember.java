...
public class ChangeMember {
  ...
  /**
   * The action you want to take, i.e. delete a list element, edit a field, add a list element to a
   * list
   */
  ...
  public static List<Object> getChangeObjects(List<ChangeMember> changeMemberList) {

    List<Object> myObjectList = new ArrayList<Object>(changeMemberList.size());

    for (ChangeMember changeMember : changeMemberList) {
      myObjectList.add(changeMember.getImejiDataObject());
    }
