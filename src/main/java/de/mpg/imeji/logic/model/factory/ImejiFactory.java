...
public class ImejiFactory {
	...
	/**
	 * Create a Sortorder: allowed values: ascending or descending. Default value =
	 * ascending
	 * 
	 * @param order
	 * @return
	 ...
	 * @return
	 */
	public static Item newItem(Item item, CollectionImeji collection, User user, String storageId, String title,
			String filetype) {
