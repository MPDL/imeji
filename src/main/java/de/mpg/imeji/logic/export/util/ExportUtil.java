...
public class ExportUtil {
  ...
  public static Map<String, Item> retrieveItems(List<String> ids, User user) throws ImejiException {
    final List<Item> items =
        (List<Item>) new ItemService().retrieveBatchLazy(ids, Search.GET_ALL_RESULTS, Search.SEARCH_FROM_START_INDEX, user);
   ...
   * @throws ImejiException
   */
  public static String getPath(CollectionImeji topParent, CollectionImeji current, User user) throws ImejiException {
   ...
   * @throws ImejiException
   */
  public static String getPath(CollectionImeji topParent, Item item, User user) throws ImejiException {
