...
/**
 * Listen for a particular MessageType is called as soon as one message with the
 * same MessageType is added to the queue
 * 
 * @author saquet
 *
 */
public abstract class Listener implements Callable<Integer> {
	...
	/**
	 * Set of message types {@link MessageType} the listener wants to receive a
	 * notification for
	 */
