...
public class Authorization implements Serializable {
	...
	/**
	 * Transform a list of String (with the format: GrantType,GrantFor) to a list of
	 * {@link Grant}
	 *
	 * @param grants
	 * @return
	...
	/**
	 * True if the object is shared with the user. Even if the object is public,
	...
	private boolean hasEditGrant(Collection<String> grants, String uri) {
		return toGrantList(grants).stream()
				.anyMatch(g -> g.getGrantFor().equals(uri) && (g.getGrantType().equals(GrantType.EDIT.toString())
	...
	/**
	 * True if the {@link Status} is a public status(i.e. not need to have special
	 * grants to read the object)
	 *
	 * @param status
	 * @return
	 */
