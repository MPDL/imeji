...
public class ShareService {
	 ...
	 * @param profileUri
	 *            - (only for collections) the uri of the profile of the collection
	 * @param roles
	 ...
	 * @throws ImejiException
	 */
	private void shareGrantsToGroup(User fromUser, UserGroup toGroup, String sharedObjectUri, Grant grant)
			throws ImejiException {
		if (toGroup != null) {
			checkSecurity(fromUser, sharedObjectUri);
	...
	/**
	 * Add to the {@link User} the {@link List} of {@link Grant} and update the user
	 * in the database
	 *
	 * @param toUser
	 * @param g
	...
	/**
	 * Add to the {@link UserGroup} the {@link List} of {@link Grant} and update the
	...
	/**
	 * Add a grant to a list of grant if the grant is not null. All grants with the
	 * same grantFor with be removed
	 *
	 * @param grants
	 * @param grant
	 * @param uri
