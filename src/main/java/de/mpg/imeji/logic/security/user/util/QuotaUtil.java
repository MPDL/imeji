...
public class QuotaUtil {
  ...
  public static long checkQuota(User user, File file, CollectionImeji col) throws ImejiException {
    ...
    try {
      ...
      throw new UnprocessableError("Cannot parse currentDiskSpaceUsage " + "; requested by user: " + user.getEmail()
          + "; targetCollectionUser: " + targetCollectionUser.getEmail(), e);
    }
   ...
   * @throws ImejiException
   */
  public static long checkQuota(long currentDiskUsage, User user, File file, CollectionImeji col) throws ImejiException {
