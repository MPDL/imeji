...
public class ImejiRsaKeys {
  ...
  public static void init(String publicKeyJson, String privateKeyString)
    ...
    if (!StringHelper.isNullOrEmptyTrim(publicKeyJson) && !StringHelper.isNullOrEmptyTrim(privateKeyString)) {
   ...
   * @throws InvalidKeySpecException
   */
  private static PrivateKey generatePrivateKey(String privateKeyString) throws NoSuchAlgorithmException, InvalidKeySpecException {
