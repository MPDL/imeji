...
public final class DoiService {
   ...
   * @throws ImejiException
   */
  public void addProvidedDoiToCollection(CollectionImeji collection, User user)
      throws ImejiException {
   ...
   * @throws Exception
   */
  private String getNewMPGDoi(CollectionImeji col, String doiServiceUrl, String doiUser,
