...
public class ImejiConfiguration {
  ...
  private enum CONFIGURATION {
    ...
    EMAIL_SERVER_ENABLE_AUTHENTICATION,
    EMAIL_SERVER_SENDER,
    EMAIL_SERVER_PORT,
    UPLOAD_WHITE_LIST,
    UPLOAD_BLACK_LIST,
    ...
    TECHNICAL_METADATA,
    THUMBNAIL_WIDTH,
    WEB_RESOLUTION_WIDTH,
    STATEMENTS,
    NUMBER_OF_LINES_IN_THUMBNAIL_LIST,
    GOOGLE_MAPS_API,
    CONE_AUTHORS,
    DOI_PUBLISHER,
    FACET_DISPLAYED,
  ...
  private synchronized void readConfig() throws IOException, ImejiException {
    ...
    try {
      ...
      throw new ImejiException("conf.xml could not be read. Please check in tdb directory if exsting and not empty. If Emtpy, remove it.");
    }
