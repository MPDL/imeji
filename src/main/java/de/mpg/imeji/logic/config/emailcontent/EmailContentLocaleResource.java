...
public class EmailContentLocaleResource {
  ...
  /**
   * Internal representation of content of the associated file Data structure contains a list of
   * identifiers and mapped email content
   */
  private EmailContentListXML emailContent;

  /**
   * Create a resource class to access a XML file in the file system that contains user configures
   * content for e-mails (subject and message) in the given language
   * 
  ...
  /**
   * Read customized email content (email subject and email message) from an associated file in the
   * file system. Cache this information in a map-like data structure
   */
  ...
  /**
   * Write email content to associated file only if the content has been changed/edited in GUI
   * before
   */
