...
public class ProxyHelper {
	...
	/**
	 * Returns <code>java.net.Proxy</code> class for
	 * <code>java.net.URL.openConnection</code> creation
	 *
	 * @param url
	 *            url
	 * @throws Exception
	 ...
	 *
	 * @param url
	 * @return <code>true</code> if <code>url</code> is found, <code>false</code>
	 *         otherwise
	 */
