 ...
 * its corresponding locale Class is used for processing (reading/writing) XML file with JAXB
 * 
 * @author breddin
 *
 */
public class EmailContentXML {
   ...
   * regardless of whether this text has been changed in GUI or not Use listener for update of
   * message in cache
   * 
   * @param text
   */
