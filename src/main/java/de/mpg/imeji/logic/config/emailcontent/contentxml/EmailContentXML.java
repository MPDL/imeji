...
/**
 * Represents an email message that exists in different languages Class holds an
 * email message and its corresponding locale Class is used for processing
 * (reading/writing) XML file with JAXB
 * 
 * @author breddin
 *
 */
public class EmailContentXML {
	...
	/**
	 * Remark: setter methods will get called by JSF layer always when saving (to
	 * update the model) regardless of whether this text has been changed in GUI or
	 * not Use listener for update of message in cache
	 * 
	 * @param text
	 */
