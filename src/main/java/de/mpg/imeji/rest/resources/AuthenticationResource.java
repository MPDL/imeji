...
public class AuthenticationResource {
	...
	@POST
	@Path("/login")
	@ApiOperation(value = "Login to API", notes = "You can either login with: " + "<br/>"
	...
	@POST
	@Path("/logout")
	@ApiOperation(value = "Logout from the API", notes = "The APIKey of the current User (according to authorization header) will be invalidated. User will need to login with Basic Authentication to get a new Key")
	@Produces(MediaType.APPLICATION_JSON)
