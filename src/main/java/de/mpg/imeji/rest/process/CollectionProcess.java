...
public class CollectionProcess {
   ...
   * @return
   */
  public static JSONResponse getCollectionElements(HttpServletRequest req, String id, String q, int offset, int size, String sortBy,
      String order) {
    JSONResponse resp = null;
    User u = null;
    final CollectionAPIService ccrud = new CollectionAPIService();
  ...
  public static JSONResponse withdrawCollection(HttpServletRequest req, String id, String discardComment) throws Exception {
    JSONResponse resp;
