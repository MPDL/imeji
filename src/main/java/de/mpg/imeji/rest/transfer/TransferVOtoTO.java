...
public class TransferVOtoTO {
   ...
   * @return
   */
  private static List<ContainerAdditionalInformationTO> transferAdditionalInfos(List<ContainerAdditionalInfo> vos) {
  ...
  public static void transferProperties(Properties vo, PropertiesTO to) {
    ...
    // set createdBy
    to.setCreatedBy(new PersonTOBasic(userNameCache.getUserName(vo.getCreatedBy()), ObjectHelper.getId(vo.getCreatedBy())));
    // set modifiedBy
    to.setModifiedBy(new PersonTOBasic(userNameCache.getUserName(vo.getModifiedBy()), ObjectHelper.getId(vo.getCreatedBy())));
  ...
  public static void transferDefaultItem(Item vo, DefaultItemTO to) {
    ...
    to.setFileUrl(URI.create(Imeji.PROPERTIES.getApplicationURL() + "file?itemId=" + vo.getIdString() + "&resolution=original"));
  }
   ...
   * @return
   */
  private static List<de.mpg.imeji.rest.to.LicenseTO> transferLicense(List<de.mpg.imeji.logic.model.License> licenses) {
