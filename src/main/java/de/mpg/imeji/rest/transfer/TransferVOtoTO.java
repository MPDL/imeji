...
public class TransferVOtoTO {
	...
	/**
	 * Transfer a list of ContainerAdditionalInfo to a list of
	 * ContainerAdditionalInformationTO
	 *
	 * @param vos
	 * @return
	 */
	...
	public static void transferProperties(Properties vo, PropertiesTO to) {
		...
		// set createdBy
		to.setCreatedBy(
				new PersonTOBasic(userNameCache.getUserName(vo.getCreatedBy()), ObjectHelper.getId(vo.getCreatedBy())));
		// set modifiedBy
	...
	public static void transferDefaultItem(Item vo, DefaultItemTO to) {
		...
		to.setFileUrl(URI.create(
				Imeji.PROPERTIES.getApplicationURL() + "file?itemId=" + vo.getIdString() + "&resolution=original"));
	}
