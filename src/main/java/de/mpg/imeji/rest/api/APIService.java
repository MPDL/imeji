...
public interface APIService<V> {
	...
	/**
	 * Share an object defined by id to a user defined by userid. The roles to added
	 * are passed into a List of String
	 *
	 * @param id
	 * @param userId
	 * @param roles
	...
	/**
	 * Unshare an object defined by id from a user defined by userid. The roles to
	 * be removed are passed into a List of String
	 *
	 * @param id
	 * @param userId
	 * @param roles
