...
public abstract class Transaction {
	...
	/**
	 * Execute the operation of the {@link Transaction} Is called after the
	 * {@link Transaction} has been started
	 *
	 * @param ds
	 * @throws Exception
	 */
	...
	/**
	 * Return the type of Jena lock ({@link ReadWrite}) uses for the
	 * {@link Transaction}
	 *
	 * @return
	 */
	...
	/**
	 * Return the {@link Model} of the {@link Dataset} according to the uri defined
	 * in constructor
	 *
	 * @param dataset
	 * @return
