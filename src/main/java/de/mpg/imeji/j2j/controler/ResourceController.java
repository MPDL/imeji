...
/**
 * Controller for {@link RDFResource} Attention: Non transactional!!!! Don't use
 * directly, use JenaWriter of JenaReader instead
 *
...
public class ResourceController {
	...
	/**
	 * Use for transaction. The model must have been created/retrieved within the
	 * transaction
	 *
	 * @param model
	 * @param lazy
	...
	public Object read(Object o) throws NotFoundException {
		if (!java2rdf.exists(o)) {
			throw new NotFoundException(
					getObjectType(J2JHelper.getId(o)) + " " + getObjectId(J2JHelper.getId(o)) + " not found!");
		}
	...
	public void delete(Object o) throws NotFoundException {
		if (!java2rdf.exists(o)) {
			throw new NotFoundException("Error deleting resource " + J2JHelper.getId(o).getPath().replace("imeji/", "")
