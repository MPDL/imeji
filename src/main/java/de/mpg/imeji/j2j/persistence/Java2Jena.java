...
public class Java2Jena {
  ...
  public void update(String uri, String property, Object obj) {
    ...
    if (obj instanceof URI) {
      ...
      final Literal o = model.createLiteral(((LocalizedString) obj).getValue(), ((LocalizedString) obj).getLang());
      p = RDFS.label;
      if (o != null) {
        model.add(r, p, o);
      }
        ...
        try {
          ...
          if (J2JHelper.isResource(r2) && exists(r2)) {
            ...
            if (isListOfResources) {
              ...
              for (final StmtIterator iterator = parent.listProperties(model.createProperty(predicate)); iterator.hasNext();) {
