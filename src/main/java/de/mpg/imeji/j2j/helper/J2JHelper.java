...
public class J2JHelper {
	...
	public static boolean isLazyURIResource(Object o, Field f) {
		return f != null && (f.getType().equals(URI.class) && f.getAnnotation(j2jLazyURIResource.class) != null
	...
	/**
	 * Return a {@link Field} as a {@link Object} of the same {@link Class} as the
	 * {@link Object} passed as parameter
	 *
	 * @param f
	 * @param o
	 * @return
	...
	/**
	 * Return all the Fields that should be written as rdf property If class is not
	 * inheriting from a {@link RDFObject} then return empty list.
	 *
	 * @param clazz
	 * @return
	 */
