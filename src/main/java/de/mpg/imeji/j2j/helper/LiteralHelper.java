...
public class LiteralHelper {
  ...
  public Literal java2Literal(Object o) {
    try {
      Literal l = null;
      if (o instanceof Calendar || o instanceof Boolean || o instanceof Character || o instanceof Float || o instanceof Integer
          || o instanceof Long || o instanceof String || o instanceof Double) {
